...
int main() {
    ...
    cnt = 0;
    if (n >= 13){
        for(int a13 = 0; a13 < n - 11; a13++){
            if (a[a13] >= c) continue;

            for(int i = a13 + 1; i < n - 10; i++){
                if ((tmp11 = sum(a[13], a[i])) >= c) continue;
